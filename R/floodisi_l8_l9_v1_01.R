...
# Bazzan, T.; Renno, C.D.; Reckziegel, E.W.; Guasselli, L.A.; Korb, C.C. Flood Detection Integrating Spectral Indices (FLOODISI): A new approach to open-water mapping. Manuscript under review. 2026
...
image <- rast("D:/floodisi/image/20240508/20240508_l8_bands_aoi_bhsinos_reflectancia.tif")
...
writeRaster(ndwi1_index, "D:/floodisi/repositorio/ndwi1_index.tif", overwrite = TRUE)
...
writeRaster(ndwi1_water_map, "D:/floodisi/repositorio/ndwi1_water_map.tif", overwrite = TRUE)
...
writeRaster(ndwi1_water_map_corrected, "D:/floodisi/repositorio/ndwi1_water_map_corrected.tif", overwrite = TRUE)
...
writeRaster(ndwi2_index, "D:/floodisi/repositorio/ndwi2_index.tif", overwrite = TRUE)
...
writeRaster(ndwi2_water_map, "D:/floodisi/repositorio/ndwi2_water_map.tif", overwrite = TRUE)
...
writeRaster(ndwi2_water_map_corrected, "D:/floodisi/repositorio/ndwi2_water_map_corrected.tif", overwrite = TRUE)
...
writeRaster(ndwi3_index, "D:/floodisi/repositorio/ndwi3_index.tif", overwrite = TRUE)
...
writeRaster(ndwi3_water_map, "D:/floodisi/repositorio/ndwi3_water_map.tif", overwrite = TRUE)
...
writeRaster(ndwi3_water_map_corrected, "D:/floodisi/repositorio/ndwi3_water_map_corrected.tif", overwrite = TRUE)
...
writeRaster(mndwi_index, "D:/floodisi/repositorio/mndwi_index.tif", overwrite = TRUE)
...
writeRaster(mndwi_water_map, "D:/floodisi/repositorio/mndwi_water_map.tif", overwrite = TRUE)
...
writeRaster(mndwi_water_map_corrected, "D:/floodisi/repositorio/mndwi_water_map_corrected.tif", overwrite = TRUE)
...
writeRaster(wri_index, "D:/floodisi/repositorio/wri_index.tif", overwrite = TRUE)
...
writeRaster(wri_water_map, "D:/floodisi/repositorio/wri_water_map.tif", overwrite = TRUE)
...
writeRaster(wri_water_map_corrected, "D:/floodisi/repositorio/wri_water_map_corrected.tif", overwrite = TRUE)
...
writeRaster(ndfi1_index, "D:/floodisi/repositorio/ndfi1_index.tif", overwrite = TRUE)
...
writeRaster(ndfi1_water_map, "D:/floodisi/repositorio/ndfi1_water_map.tif", overwrite = TRUE)
...
writeRaster(ndfi1_water_map_corrected, "D:/floodisi/repositorio/ndfi1_water_map_corrected.tif", overwrite = TRUE)
...
writeRaster(ndfi2_index, "D:/floodisi/repositorio/ndfi2_index.tif", overwrite = TRUE)
...
writeRaster(ndfi2_water_map, "D:/floodisi/repositorio/ndfi2_water_map.tif", overwrite = TRUE)
...
writeRaster(ndfi2_water_map_corrected, "D:/floodisi/repositorio/ndfi2_water_map_corrected.tif", overwrite = TRUE)
...
writeRaster(aweish_index, "D:/floodisi/repositorio/aweish_index.tif", overwrite = TRUE)
...
writeRaster(aweish_water_map, "D:/floodisi/repositorio/aweish_water_map.tif", overwrite = TRUE)
...
writeRaster(aweish_water_map_corrected, "D:/floodisi/repositorio/aweish_water_map_corrected.tif", overwrite = TRUE)
...
writeRaster(aweinsh_index, "D:/floodisi/repositorio/aweinsh_index.tif", overwrite = TRUE)
...
writeRaster(aweinsh_water_map, "D:/floodisi/repositorio/aweinsh_water_map.tif", overwrite = TRUE)
...
writeRaster(aweinsh_water_map_corrected, "D:/floodisi/repositorio/aweinsh_water_map_corrected.tif", overwrite = TRUE)
...
writeRaster(wi2015_index, "D:/floodisi/repositorio/wi2015_index.tif", overwrite = TRUE)
...
writeRaster(wi2015_water_map, "D:/floodisi/repositorio/wi2015_water_map.tif", overwrite = TRUE)
...
writeRaster(wi2015_water_map_corrected, "D:/floodisi/repositorio/wi2015_water_map_corrected.tif", overwrite = TRUE)
...
writeRaster(mbwi_index, "D:/floodisi/repositorio/mbwi_index.tif", overwrite = TRUE)
...
writeRaster(mbwi_water_map, "D:/floodisi/repositorio/mbwi_water_map.tif", overwrite = TRUE)
...
writeRaster(mbwi_water_map_corrected, "D:/floodisi/repositorio/mbwi_water_map_corrected.tif", overwrite = TRUE)
...
water_frequency_map <- ndwi1_water_map_corrected + ndwi2_water_map_corrected + 
  ...
  aweinsh_water_map_corrected + wi2015_water_map_corrected + mbwi_water_map_corrected
...
writeRaster(water_frequency_map, "D:/floodisi/repositorio/water_frequency_map.tif", overwrite = TRUE)
...
writeRaster(integrated_water_map, "D:/floodisi/repositorio/integrated_water_map.tif", overwrite = TRUE)
...
list_area <- list(name = c("NDWI-1", "NDWI-2", "NDWI-3", "MNDWI", 
                 ...
                 area = c(ndwi1_water_area_km2, ndwi2_water_area_km2, 
                          ...
                          mbwi_water_area_km2, integrated_water_map_water_area_km2))
