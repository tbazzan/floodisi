...
# Bazzan, T.; Renno, C.D.; Reckziegel, E.W.; Guasselli, L.A.; Korb, C.C. Flood Detection Integrating Spectral Indices (FLOODISI): A novel approach to open-water mapping. Geosciences, 2026, in press.
...
image <- rast("D:/image_s2.tif")
names(image) <- c("band1", "band2", "band3", "band4", "band5", "band6", "band7", "band8", "band8a","band9", "band11", "band12")
image
plot(image)

# Rename bands

names(image) <- c("coastal", "blue", "green", "red", "red_edge1", "red_edge2", "red_edge3", 
                  "nir", "narrow_nir", "water_vapour", "swir1", "swir2")
image
plot(image)
...
# BAZZAN, T.; RENNO, C.D.; RECKZIEGEL, E.W.; GUASSELLI, L. A.; KORB, C.C. Flood Detection Integrating Spectral Indices (FLOODISI): A novel approach to open-water mapping. Manuscript under review. 2026
